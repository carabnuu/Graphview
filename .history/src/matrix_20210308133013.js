 			...
 			_this.locallayer.append('rect')
							...
							.style('fill', function(d){
								if(_this.adj_matrix[d.i][d.j]==2){
									console.log(nodeSizeScale(d.id))
 									return nodeSizeScale(d.id);
							...
							.on('mouseout', function(d) {
								if (d.i!=d.j) d3.select(this).style('fill', function(){return (_this.adj_matrix[d.i][d.j]==1)?'#cbcbcb':'white';});
								if (d.i==d.j) d3.select(this).style('fill', function(){ return nodeSizeScale(d.id); });
